...
var allomedia$storybook$Book$InternalMsg = function (a) {
	return {$: 'InternalMsg', a: a};
};
var allomedia$storybook$Book$UrlChanged = function (a) {
	return {$: 'UrlChanged', a: a};
};
var allomedia$storybook$Book$UrlRequested = function (a) {
	return {$: 'UrlRequested', a: a};
};
var allomedia$storybook$Data$Bookmark$ChapterBookmark = function (a) {
	return {$: 'ChapterBookmark', a: a};
};
var allomedia$storybook$Data$Bookmark$StoryBookmark = F2(
	function (a, b) {
		return {$: 'StoryBookmark', a: a, b: b};
	});
var allomedia$storybook$Data$Bookmark$UiBookmark = F3(
	function (a, b, c) {
		return {$: 'UiBookmark', a: a, b: b, c: c};
	});
...
var allomedia$storybook$Book$setRoute = F2(
	function (route, model) {
		if (route.$ === 'Nothing') {
			...
			switch (route.a.$) {
				case 'Chapter':
					var chapterId = route.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bookmark: allomedia$storybook$Data$Bookmark$ChapterBookmark(chapterId)
							}),
				...
				case 'Story':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bookmark: A2(allomedia$storybook$Data$Bookmark$StoryBookmark, chapterId, storyId)
							}),
						elm$core$Platform$Cmd$none);
				case 'Ui':
					var _n2 = route.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bookmark: A3(allomedia$storybook$Data$Bookmark$UiBookmark, chapterId, storyId, uiId)
							}),
						elm$core$Platform$Cmd$none);
				default:
					var _n3 = route.a;
...
var allomedia$storybook$Data$Bookmark$None = {$: 'None'};
var allomedia$storybook$Data$Chapter$ChapterId = function (a) {
	return {$: 'ChapterId', a: a};
};
var elm$core$Basics$identity = function (x) {
	return x;
};
var elm$url$Url$percentDecode = _Url_percentDecode;
var allomedia$storybook$Data$Chapter$decodeChapterId = function (string) {
	var _n0 = elm$url$Url$percentDecode(string);
	if (_n0.$ === 'Just') {
		var id = _n0.a;
		return allomedia$storybook$Data$Chapter$ChapterId(id);
	} else {
		return allomedia$storybook$Data$Chapter$ChapterId('invalid');
	}
};
...
var allomedia$storybook$Data$Chapter$chapterIdParser = A2(
	elm$url$Url$Parser$custom,
	'CHAPTER_ID',
	A2(elm$core$Basics$composeL, elm$core$Maybe$Just, allomedia$storybook$Data$Chapter$decodeChapterId));
var allomedia$storybook$Data$Story$StoryId = function (a) {
	return {$: 'StoryId', a: a};
};
var allomedia$storybook$Data$Story$decodeStoryId = function (string) {
	var _n0 = elm$url$Url$percentDecode(string);
	if (_n0.$ === 'Just') {
		var id = _n0.a;
		return allomedia$storybook$Data$Story$StoryId(id);
	} else {
		return allomedia$storybook$Data$Story$StoryId('invalid');
	}
};
var allomedia$storybook$Data$Story$storyIdParser = A2(
	elm$url$Url$Parser$custom,
	'STORY_ID',
	A2(elm$core$Basics$composeL, elm$core$Maybe$Just, allomedia$storybook$Data$Story$decodeStoryId));
var allomedia$storybook$Data$Ui$UiId = function (a) {
	return {$: 'UiId', a: a};
};
var allomedia$storybook$Data$Ui$decodeUiId = function (string) {
	var _n0 = elm$url$Url$percentDecode(string);
	if (_n0.$ === 'Just') {
		var id = _n0.a;
		return allomedia$storybook$Data$Ui$UiId(id);
	} else {
		return allomedia$storybook$Data$Ui$UiId('');
	}
};
var allomedia$storybook$Data$Ui$uiIdParser = A2(
	elm$url$Url$Parser$custom,
	'UI_ID',
	A2(elm$core$Basics$composeL, elm$core$Maybe$Just, allomedia$storybook$Data$Ui$decodeUiId));
var allomedia$storybook$Route$Route$Chapter = function (a) {
	return {$: 'Chapter', a: a};
};
var allomedia$storybook$Route$Route$Home = {$: 'Home'};
var allomedia$storybook$Route$Route$Story = F2(
	function (a, b) {
		return {$: 'Story', a: a, b: b};
	});
var allomedia$storybook$Route$Route$Ui = F3(
	function (a, b, c) {
...
var allomedia$storybook$Route$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, allomedia$storybook$Route$Route$Home, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			allomedia$storybook$Route$Route$Chapter,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('chapters'),
				allomedia$storybook$Data$Chapter$chapterIdParser)),
			A2(
			elm$url$Url$Parser$map,
			allomedia$storybook$Route$Route$Story,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('chapters'),
				A2(
					...
					A2(
						elm$url$Url$Parser$slash,
						elm$url$Url$Parser$s('story'),
						allomedia$storybook$Data$Story$storyIdParser)))),
			A2(
			elm$url$Url$Parser$map,
			allomedia$storybook$Route$Route$Ui,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('chapters'),
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$url$Url$Parser$slash,
								elm$url$Url$Parser$s('ui'),
								allomedia$storybook$Data$Ui$uiIdParser))))))
		]));
...
var allomedia$storybook$Route$Route$fromUrl = function (url) {
	return A2(
		elm$url$Url$Parser$parse,
		allomedia$storybook$Route$Route$parser,
		_Utils_update(
			url,
			{
...
var allomedia$storybook$Book$init = F4(
	function (chapters, _n0, url, key) {
		return A2(
			allomedia$storybook$Book$setRoute,
			allomedia$storybook$Route$Route$fromUrl(url),
			{bookmark: allomedia$storybook$Data$Bookmark$None, chapters: chapters, navKey: key});
	});
...
var allomedia$storybook$Book$update = F2(
	function (msg, model) {
		if (msg.$ === 'ExternalMsg') {
			var externalMsg = msg.a;
			var _n1 = A2(elm$core$Debug$log, 'msg', externalMsg);
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		} else {
			var internalMsg = msg.a;
			switch (internalMsg.$) {
				case 'UrlChanged':
					var url = internalMsg.a;
					return A2(
						allomedia$storybook$Book$setRoute,
						allomedia$storybook$Route$Route$fromUrl(url),
						model);
				case 'UrlRequested':
					var urlRequest = internalMsg.a;
...
var allomedia$storybook$Book$ExternalMsg = function (a) {
	return {$: 'ExternalMsg', a: a};
};
var allomedia$storybook$Data$Ui$uiIdToString = function (_n0) {
	var id = _n0.a;
	return id;
};
var allomedia$storybook$Data$Chapter$chapterIdToString = function (_n0) {
	var id = _n0.a;
	return id;
};
var allomedia$storybook$Data$Story$storyIdToString = function (_n0) {
	var id = _n0.a;
	return id;
};
var elm$url$Url$percentEncode = _Url_percentEncode;
var allomedia$storybook$Route$Route$routeToString = function (route) {
	var pieces = function () {
		switch (route.$) {
			case 'Home':
				return _List_Nil;
			case 'Chapter':
				var chapterId = route.a;
				return _List_fromArray(
					[
						'chapters',
						elm$url$Url$percentEncode(
						allomedia$storybook$Data$Chapter$chapterIdToString(chapterId))
					]);
			case 'Story':
				var chapterId = route.a;
				var storyId = route.b;
				return _List_fromArray(
					[
						...
						'story',
						elm$url$Url$percentEncode(
						allomedia$storybook$Data$Story$storyIdToString(storyId))
					]);
			default:
				var chapterId = route.a;
				var storyId = route.b;
				...
				return _List_fromArray(
					[
						...
						'ui',
						elm$url$Url$percentEncode(
						allomedia$storybook$Data$Ui$uiIdToString(uiId))
					]);
		}
	}();
...
var allomedia$storybook$Route$Route$href = function (route) {
	return rtfeldman$elm_css$Html$Styled$Attributes$href(
		allomedia$storybook$Route$Route$routeToString(route));
};
...
var allomedia$storybook$Theme$Submenu$item = A2(
...
var allomedia$storybook$Theme$Submenu$default = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					rtfeldman$elm_css$Css$px(3),
					rtfeldman$elm_css$Css$solid,
					A4(rtfeldman$elm_css$Css$rgba, 99, 167, 245, 0.8))
				]))
		]));
var rtfeldman$elm_css$Html$Styled$a = rtfeldman$elm_css$Html$Styled$node('a');
var allomedia$storybook$Theme$Submenu$link = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$a,
	_List_fromArray(
		[allomedia$storybook$Theme$Submenu$default]));
var rtfeldman$elm_css$Html$Styled$span = rtfeldman$elm_css$Html$Styled$node('span');
var allomedia$storybook$Theme$Submenu$linkActive = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	...
	_List_fromArray(
		[
			...
			rtfeldman$elm_css$Css$px(3),
			rtfeldman$elm_css$Css$solid,
			A4(rtfeldman$elm_css$Css$rgba, 99, 167, 245, 1))
		]));
...
var allomedia$storybook$Book$submenuUiView = F4(
	function (bookmark, chapter, story, ui) {
		return A2(
			allomedia$storybook$Theme$Submenu$item,
			_List_Nil,
			_List_fromArray(
				[
					function () {
					if (bookmark.$ === 'UiBookmark') {
						var chapterId = bookmark.a;
						var storyId = bookmark.b;
						var uiId = bookmark.c;
						return _Utils_eq(
							allomedia$storybook$Data$Ui$uiIdToString(uiId),
							ui.name) ? A2(
							allomedia$storybook$Theme$Submenu$linkActive,
							_List_Nil,
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text(ui.name)
								])) : A2(
							allomedia$storybook$Theme$Submenu$link,
							_List_fromArray(
								[
									allomedia$storybook$Route$Route$href(
									A3(allomedia$storybook$Route$Route$Ui, chapterId, storyId, uiId))
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text(ui.name)
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A3(
										allomedia$storybook$Route$Route$Ui,
										allomedia$storybook$Data$Chapter$ChapterId(chapter.a),
										allomedia$storybook$Data$Story$StoryId(story.a),
										allomedia$storybook$Data$Ui$UiId(ui.name)))
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text(ui.name)
...
var allomedia$storybook$Theme$Submenu$view = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$ul,
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$backgroundColor(
			A3(rtfeldman$elm_css$Css$rgb, 248, 248, 248)),
			A3(
			rtfeldman$elm_css$Css$borderBottom3,
			rtfeldman$elm_css$Css$px(1),
			rtfeldman$elm_css$Css$solid,
			A3(rtfeldman$elm_css$Css$rgb, 181, 181, 181)),
			rtfeldman$elm_css$Css$margin(rtfeldman$elm_css$Css$zero),
			rtfeldman$elm_css$Css$height(
			rtfeldman$elm_css$Css$px(80)),
			A2(rtfeldman$elm_css$Css$property, 'display', 'grid'),
			A2(rtfeldman$elm_css$Css$property, 'grid-auto-flow', 'column'),
			A2(rtfeldman$elm_css$Css$property, 'justify-content', 'flex-start'),
			A2(rtfeldman$elm_css$Css$property, 'align-items', 'flex-end'),
			rtfeldman$elm_css$Css$listStyle(rtfeldman$elm_css$Css$none),
			rtfeldman$elm_css$Css$padding(rtfeldman$elm_css$Css$zero),
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$pct(100))
		]));
var allomedia$storybook$Book$submenuView = F3(
	function (bookmark, chapter, story) {
		return A2(
			allomedia$storybook$Theme$Submenu$view,
			_List_Nil,
			A2(
				elm$core$List$map,
				A3(allomedia$storybook$Book$submenuUiView, bookmark, chapter, story),
				story.b));
	});
var allomedia$storybook$Data$Chapter$find = F2(
	function (id, chapts) {
		return elm$core$List$head(
			A2(
				...
				function (_n0) {
					var title = _n0.a;
					return _Utils_eq(title, id);
				},
				chapts));
	});
var allomedia$storybook$Data$Story$find = F2(
	function (id, stories) {
		return elm$core$List$head(
			A2(
				elm$core$List$filter,
				function (story) {
					return _Utils_eq(story.a, id);
				},
				stories));
	});
var allomedia$storybook$Data$Ui$find = F2(
	function (name, uis) {
		return elm$core$List$head(
			A2(
				elm$core$List$filter,
				function (ui) {
					return _Utils_eq(ui.name, name);
				},
				uis));
	});
...
var allomedia$storybook$Book$contentView = function (model) {
	...
	switch (bookmark.$) {
		case 'None':
			return A2(
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('No bookmark')
					]));
		case 'StoryBookmark':
			var chapterId = bookmark.a;
			var storyId = bookmark.b;
			var _n1 = A2(
				allomedia$storybook$Data$Chapter$find,
				allomedia$storybook$Data$Chapter$chapterIdToString(chapterId),
				chapters);
			if (_n1.$ === 'Just') {
				var chapter = _n1.a;
				var _n2 = A2(
					allomedia$storybook$Data$Story$find,
					allomedia$storybook$Data$Story$storyIdToString(storyId),
					chapter.b);
				if (_n2.$ === 'Just') {
					var story = _n2.a;
					return A3(allomedia$storybook$Book$submenuView, bookmark, chapter, story);
				} else {
					return A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_Nil,
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('none')
							]));
				}
			} else {
				return A2(
		...
		case 'UiBookmark':
			...
			if (_n3.$ === 'Just') {
				...
				if (_n4.$ === 'Just') {
					var story = _n4.a;
					var _n5 = A2(
						allomedia$storybook$Data$Ui$find,
						allomedia$storybook$Data$Ui$uiIdToString(uiId),
						story.b);
					if (_n5.$ === 'Just') {
						var ui = _n5.a;
						return A2(
							...
							_List_fromArray(
								[
									A3(allomedia$storybook$Book$submenuView, bookmark, chapter, story),
									A2(
									rtfeldman$elm_css$Html$Styled$div,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											A2(rtfeldman$elm_css$Html$Styled$map, allomedia$storybook$Book$ExternalMsg, ui.view)
										]))
								]));
					} else {
						return A2(
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('BAH ALORS')
					]));
	}
};
...
var allomedia$storybook$Theme$Sidebar$defaultItem = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$backgroundColor(
					A3(rtfeldman$elm_css$Css$rgb, 99, 167, 245)),
					rtfeldman$elm_css$Css$borderRadius(
					rtfeldman$elm_css$Css$px(3))
				]))
		]));
var allomedia$storybook$Theme$Sidebar$item = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$a,
	_List_fromArray(
		[allomedia$storybook$Theme$Sidebar$defaultItem]));
var allomedia$storybook$Theme$Sidebar$itemActive = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$span,
	_List_fromArray(
		[
...
var allomedia$storybook$Book$sidebarStoryView = F3(
	function (bookmark, chapter, story) {
		var chapterTitle = chapter.a;
		var storyTitle = story.a;
		switch (bookmark.$) {
			case 'StoryBookmark':
				var chapterId = bookmark.a;
				var storyId = bookmark.b;
				return _Utils_eq(
					storyTitle,
					allomedia$storybook$Data$Story$storyIdToString(storyId)) ? A2(
					allomedia$storybook$Theme$Sidebar$itemActive,
					_List_Nil,
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(storyTitle)
						])) : A2(
					allomedia$storybook$Theme$Sidebar$item,
					_List_fromArray(
						[
							allomedia$storybook$Route$Route$href(
							A2(
								allomedia$storybook$Route$Route$Story,
								allomedia$storybook$Data$Chapter$ChapterId(chapterTitle),
								allomedia$storybook$Data$Story$StoryId(storyTitle)))
						]),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(storyTitle)
...
var allomedia$storybook$Theme$Sidebar$title = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$span,
	_List_fromArray(
		[
...
var allomedia$storybook$Book$sidebarChapterView = F2(
	function (bookmark, chapter) {
		var title = chapter.a;
		var stories = chapter.b;
		return A2(
			rtfeldman$elm_css$Html$Styled$li,
			_List_Nil,
			_List_fromArray(
				[
					A2(
					allomedia$storybook$Theme$Sidebar$title,
					_List_Nil,
					_List_fromArray(
						[
					...
					A2(
						elm$core$List$map,
						A2(allomedia$storybook$Book$sidebarStoryView, bookmark, chapter),
						stories))
				]));
	});
var rtfeldman$elm_css$Css$marginTop = rtfeldman$elm_css$Css$prop1('margin-top');
var allomedia$storybook$Theme$Sidebar$list = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$ul,
	_List_fromArray(
		[
...
var allomedia$storybook$Theme$Sidebar$view = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$backgroundColor(
			A3(rtfeldman$elm_css$Css$rgb, 47, 51, 56)),
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$pct(100)),
			rtfeldman$elm_css$Css$height(
			rtfeldman$elm_css$Css$pct(100)),
...
var allomedia$storybook$Book$sidebarView = F2(
	function (bookmark, chapters) {
		return A2(
			allomedia$storybook$Theme$Sidebar$view,
			_List_Nil,
			_List_fromArray(
				[
					A2(
					allomedia$storybook$Theme$Sidebar$list,
					_List_Nil,
					A2(
						elm$core$List$map,
						allomedia$storybook$Book$sidebarChapterView(bookmark),
						chapters))
				]));
	});
...
var rtfeldman$elm_css$Css$serif = {fontFamily: rtfeldman$elm_css$Css$Structure$Compatible, value: 'serif'};
...
var allomedia$storybook$Book$bodyView = function (model) {
	var chapters = model.chapters;
	var bookmark = model.bookmark;
	return _List_fromArray(
		[
			...
			A2(
				...
				_List_fromArray(
					[
						A2(allomedia$storybook$Book$sidebarView, bookmark, chapters),
						allomedia$storybook$Book$contentView(model)
					])))
		]);
};
var allomedia$storybook$Data$Bookmark$title = function (bookmark) {
	switch (bookmark.$) {
		case 'ChapterBookmark':
			var chapterId = bookmark.a;
			return allomedia$storybook$Data$Chapter$chapterIdToString(chapterId);
		case 'StoryBookmark':
			var chapterId = bookmark.a;
			var storyId = bookmark.b;
			return allomedia$storybook$Data$Chapter$chapterIdToString(chapterId) + (' :: ' + allomedia$storybook$Data$Story$storyIdToString(storyId));
		case 'UiBookmark':
			var chapterId = bookmark.a;
			var storyId = bookmark.b;
			var uiId = bookmark.c;
...
var allomedia$storybook$Book$view = function (model) {
	var bookmark = model.bookmark;
	return {
		body: allomedia$storybook$Book$bodyView(model),
		title: allomedia$storybook$Data$Bookmark$title(bookmark)
	};
};
var elm$browser$Browser$application = _Browser_application;
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var allomedia$storybook$Book$book = function (chapters) {
	return elm$browser$Browser$application(
		{
			init: allomedia$storybook$Book$init(chapters),
			onUrlChange: function (url) {
				return allomedia$storybook$Book$InternalMsg(
					allomedia$storybook$Book$UrlChanged(url));
			},
			onUrlRequest: function (urlRequest) {
				return allomedia$storybook$Book$InternalMsg(
					allomedia$storybook$Book$UrlRequested(urlRequest));
			},
			subscriptions: elm$core$Basics$always(elm$core$Platform$Sub$none),
			update: allomedia$storybook$Book$update,
			view: allomedia$storybook$Book$view
		});
};
var allomedia$storybook$Main$Yo = {$: 'Yo'};
...
var allomedia$storybook$Main$chapterList = _List_fromArray(
	[
		_Utils_Tuple2(
		'Chapter éeze1',
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						view: A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Events$onClick(allomedia$storybook$Main$Yo)
								]),
							_List_Nil)
					}
					])),
...
var allomedia$storybook$Main$main = allomedia$storybook$Book$book(allomedia$storybook$Main$chapterList);
_Platform_export({'Main':{'init':allomedia$storybook$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Book.Msg Main.MsgEx","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Book.Msg":{"args":["msg"],"tags":{"ExternalMsg":["msg"],"InternalMsg":["Book.Internal"]}},"Main.MsgEx":{"args":[],"tags":{"Yo":[]}},"Book.Internal":{"args":[],"tags":{"UrlChanged":["Url.Url"],"UrlRequested":["Browser.UrlRequest"],"NoOp":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}}}}})}});}(this));